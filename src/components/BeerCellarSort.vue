  ...
  <transition>
    <div class="beer-cellar-sort">
      ...
      <div class="beer-cellar-sort__button-wrapper flex">
        ...
        <button class="beer-cellar-sort__button pointer" :class="{ '--active': sortedBy === 'date' && !reversed }" @click="sortBeers('date', false)">Date (new-old)</button>
        <button class="beer-cellar-sort__button pointer" :class="{ '--active': sortedBy === 'date' && reversed }" @click="sortBeers('date', true)">Date (old-new)</button>
      </div>
    </div>
  </transition>
</template>
