...
<template>
  <section class="beer-form">
    <form id="beer-form" ref="beerForm">
      ...
      <input id="abv" ref="abv" class="beer-form__input --small" type="number" placeholder="Abv" v-model.number="newBeer.abv" @input="checkValidity" @invalid="reportError" min="0" max="99" step="0.1" data-error="Please enter the alcohol content">
      ...
      <input id="quantity" ref="quantity" class="beer-form__input --small" type="number" placeholder="Quantity" v-model.number="newBeer.quantity" @input="checkValidity" @invalid="reportError" min="1" data-error="Please enter the number of beers">
      <input id="date" ref="date" class="beer-form__input" type="date --small" placeholder="Date" v-model="newBeer.date" :max="maxDate">
